...
class RptPodcastDayEpisodeCountry(Base):
    __tablename__ = "RptPodcastDayEpisodeCountry"
...
class StageRptPodcastDayEpisodeCountry(Base):
    __tablename__ = "StageRptPodcastDayEpisodeCountry"
    __table_args__ = {"schema":"Triton.dbo"}
