...
class RptStreamCityRegionWeek(Base):
    __tablename__ = "RptStreamCityRegionWeek"
...
class StageRptStreamCityRegionWeek(Base):
    __tablename__ = "StageRptStreamCityRegionWeek"
    __table_args__ = {"schema":"Triton.dbo"}
