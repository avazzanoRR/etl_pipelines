...
class RptStreamStationCountry(Base):
    __tablename__ = "RptStreamStationCountry"
...
class StageRptStreamStationCountry(Base):
    __tablename__ = "StageRptStreamStationCountry"
    __table_args__ = {"schema":"Triton.dbo"}
