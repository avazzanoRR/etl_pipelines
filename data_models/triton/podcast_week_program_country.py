...
class RptPodcastWeekProgramCountry(Base):
    __tablename__ = "RptPodcastWeekProgramCountry"
...
class StageRptPodcastWeekProgramCountry(Base):
    __tablename__ = "StageRptPodcastWeekProgramCountry"
    __table_args__ = {"schema":"Triton.dbo"}
