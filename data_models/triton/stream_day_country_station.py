...
class RptStreamDayCountryStation(Base):
    __tablename__ = "RptStreamDayCountryStation"
...
class StageRptStreamDayCountryStation(Base):
    __tablename__ = "StageRptStreamDayCountryStation"
    __table_args__ = {"schema":"Triton.dbo"}
