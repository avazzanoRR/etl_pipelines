...
class RptStreamWeekStationCountry(Base):
    __tablename__ = "RptStreamWeekStationCountry"
...
class StageRptStreamWeekStationCountry(Base):
    __tablename__ = "StageRptStreamWeekStationCountry"
    __table_args__ = {"schema":"Triton.dbo"}
