...
class RptStreamWeekStationPlayerCountry(Base):
    __tablename__ = "RptStreamWeekStationPlayerCountry"
...
class StageRptStreamWeekStationPlayerCountry(Base):
    __tablename__ = "StageRptStreamWeekStationPlayerCountry"
    __table_args__ = {"schema":"Triton.dbo"}
