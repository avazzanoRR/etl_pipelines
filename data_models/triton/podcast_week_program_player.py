...
class RptPodcastWeekProgramPlayer(Base):
    __tablename__ = "RptPodcastWeekProgramPlayer"
...
class StageRptPodcastWeekProgramPlayer(Base):
    __tablename__ = "StageRptPodcastWeekProgramPlayer"
    __table_args__ = {"schema":"Triton.dbo"}
