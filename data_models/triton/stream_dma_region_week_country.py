...
class RptStreamDMARegionWeekCountry(Base):
    __tablename__ = "RptStreamDMARegionWeekCountry"
...
class StageRptStreamDMARegionWeekCountry(Base):
    __tablename__ = "StageRptStreamDMARegionWeekCountry"
    __table_args__ = {"schema":"Triton.dbo"}
