...
class RptPodcastWeekProgramDMA(Base):
    __tablename__ = "RptPodcastWeekProgramDMA"
...
class StageRptPodcastWeekProgramDMA(Base):
    __tablename__ = "StageRptPodcastWeekProgramDMA"
    __table_args__ = {"schema":"Triton.dbo"}
