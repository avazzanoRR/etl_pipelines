...
class RptVideos(Base):
    ...
    video_id = Column(Unicode(100), nullable=False)
    ...
    video_published_week_date = Column(DATE, nullable=False)
    ...
    video_watch_time_hours = Column(Numeric(18, 4), nullable=False)
