...
class DimConstituentPrimaryAddressCountry(Base):
    __tablename__ = "DimConstituentPrimaryAddressCountry"
    ...
    preferred_country = Column(Unicode(100), nullable=False)
...
class StageDimConstituentPrimaryAddressCountry(Base):
    __tablename__ = "StageDimConstituentPrimaryAddressCountry"
    __table_args__ = {"schema": "RaisersEdge.dbo"}
