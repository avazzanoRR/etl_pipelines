...
class RptAppReportMonthCountry(Base):
    __tablename__ = "RptAppReportMonthCountry"
...
class StageRptAppReportMonthCountry(Base):
    __tablename__ = "StageRptAppReportMonthCountry"
    __table_args__ = {"schema":"GoogleAnalytics.dbo"}
