...
class RptAppReportYearCountry(Base):
    __tablename__ = "RptAppReportYearCountry"
...
class StageRptAppReportYearCountry(Base):
    __tablename__ = "StageRptAppReportYearCountry"
    __table_args__ = {"schema":"GoogleAnalytics.dbo"}
