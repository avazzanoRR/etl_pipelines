...
class RptAppReportQuarterCountry(Base):
    __tablename__ = "RptAppReportQuarterCountry"
...
class StageRptAppReportQuarterCountry(Base):
    __tablename__ = "StageRptAppReportQuarterCountry"
    __table_args__ = {"schema":"GoogleAnalytics.dbo"}
