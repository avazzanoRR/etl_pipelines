...
def transform(input_filepath: str, output_dir: str) -> str:
    ...
    try:
        ...
        logging.info("Converting 'list_created_datetime' to datetime.")
        data = convert_tz_string_to_datetime(data, column='list_created_datetime', timezone='America/Chicago')
