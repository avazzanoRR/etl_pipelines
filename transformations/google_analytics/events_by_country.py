...
def transform(input_filepath: str, output_dir: str) -> str:
    ...
    try:
        ...
        # Round values in the 'event_count_per_user' column to 2 decimal places
        logging.info("Rounding 'event_count_per_user' to 2 decimal places.")
        df['event_count_per_user'] = df['event_count_per_user'].round(2)
