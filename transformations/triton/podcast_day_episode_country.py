...
def transform(input_filepath: str, output_dir: str) -> str:
    ...
    try:
        ...
        # Replace all blanks/nulls in 'country' and 'episode_title' to the string 'N/A'
        logging.info("Converting blank and None values in 'country' and 'episode_title' to 'N/A'.")
