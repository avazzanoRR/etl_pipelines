...
def transform(input_filepath: str, output_dir: str) -> str:
    ...
    try:
        ...
        # Replace all blanks/nulls in 'dma', 'region', 'country', and 'episode_title' to the string 'N/A'
        logging.info("Converting blank and None values in 'dma', 'region', 'country', and 'episode_title' to 'N/A'.")
